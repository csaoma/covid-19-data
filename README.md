Jupyter Notebook used to visualize data of cases throughout individual counties in the United States. 
This is done with pandas on a chloropleth plot. 

Data is forked from NYT repository.
